...
> Wskazówka: Przykład **05_02_ui** należy uruchomić w dwóch oknach terminala. W jednym robimy to poleceniem **lesson22:ui**, natomiast w drugim **npm run lesson22:ui:server**. Następnie wystarczy przejść w przeglądarce na adres **localhost:5173**
