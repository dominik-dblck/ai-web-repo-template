...
> Last updated: {date}
>
> This document is the living source of truth for your app's architecture. The architect skill loads it as primary context. Update it after every feature cycle.
...
Link to implementation plans in tasks/ if they exist.
-->
